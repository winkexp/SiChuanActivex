========================================================================
    ACTIVEX 控件 DLL : GYHMeter 项目概述
========================================================================

控件向导已为 GYHMeter ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 GYHMeter ActiveX 控件 DLL 的每个文件的内容。
...
GYHMeterCtrl.h
    此文件包含 CGYHMeterCtrl C++ 类的声明。

GYHMeterCtrl.cpp
    此文件包含 CGYHMeterCtrl C++ 类的实现。

GYHMeterPropPage.h
    此文件包含 CGYHMeterPropPage C++ 类的声明。

GYHMeterPropPage.cpp
    此文件包含 CGYHMeterPropPage C++ 类的实现。

CGYHMeterCtrl.bmp
    此文件包含一个位图，当 CGYHMeterCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 GYHMeter.pch 的预编译头 (PCH) 文件和名为 
